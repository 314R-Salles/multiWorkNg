...
import {removeBandcampAlbumId, setBandcampAlbumId} from '../store/app.actions';

@Component({
  selector: 'app-bandcamp-new2',
  templateUrl: './bandcamp-new2.component.html',
  styleUrls: ['./bandcamp-new2.component.css']
})
export class BandcampNew2Component implements OnInit {
  ...
  constructor(private sanitizer: DomSanitizer, private appStoreService: AppStoreService) {
  }
